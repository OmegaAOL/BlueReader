...
public class Feed implements
		Parcelable,
		Comparable<Feed>,
		WritableObject<FeedCanonicalId>,
		JsonObject.JsonDeserializable,
		HasUniqueId {

	@Override
	public FeedCanonicalId getKey() {
		try {
	...
	public Feed(final CreationData creationData) {
		this();
	...
	public FeedCanonicalId getCanonicalId() throws InvalidFeedNameException {
		return new FeedCanonicalId(url);
	}
	...
	public Feed(final String url, final String title, final boolean isSortable) {
		this.url = url;
		this.title = title;
	}

	public Feed(final Parcel parcel) {
	...
	@Override
	public int compareTo(final Feed another) {
