...
public class UserPostListingURL extends PostListingURL {
	...
	public static UserPostListingURL getLiked(final String username) {
		return new UserPostListingURL(Type.LIKED, username, null, null, null, null);
	}
	...
	public enum Type {
		SAVED, HIDDEN, LIKED, DOWNVOTED, SUBMITTED
	}
	...
	public String humanReadableName(final Context context, final boolean shorter) {
		...
		switch(type) {
			...
			case LIKED:
				name = context.getString(R.string.mainmenu_liked);
				break;
