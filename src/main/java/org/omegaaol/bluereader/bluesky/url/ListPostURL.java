...
public class ListPostURL extends PostListingURL {

	public static RedditURLParser.RedditURL getList(
	...
	@Override
	public ListPostURL after(final RedditIdAndType newAfter) {
		return new ListPostURL(username, name, order, limit, before, newAfter);
	}

	@Override
	public ListPostURL limit(final Integer newLimit) {
		return new ListPostURL(username, name, order, newLimit, before, after);
	}

	public ListPostURL sort(final PostSort newOrder) {
		return new ListPostURL(username, name, newOrder, limit, before, after);
	}
	...
	int pathType() {
		return RedditURLParser.LIST_POST_LISTING_URL;
	}

	public static ListPostURL parse(final Uri uri) {
