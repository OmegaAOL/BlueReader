...
public final class Constants {
	...
	public static final class Bluesky {
		...
		static {
			final String[] defaultFeedStrings = {
					"News",
					"Trending Artists",
					"Science",
					"What's History",
		...
		public static final String PATH_CREATESESSION = "/xrpc/com.atproto.server.createSession";
		public static final String PATH_REFRESHSESSION = "/xrpc/com.atproto.server.refreshSession";
		public static final String PATH_TIMELINE = "/xrpc/app.bsky.feed.getTimeline";
		private static String PDS_HOST = "bsky.social";
		...
		public static String getPDSHost() {
			return PDS_HOST;
		}

		public static void setPDSHost(String pds) {
			PDS_HOST = pds;
		}
		...
		public static URI getUri(final String path) {
			return General.uriFromString(getScheme() + "://" + getPDSHost() + path);
		}
