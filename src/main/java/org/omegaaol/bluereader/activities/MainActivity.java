...
import org.omegaaol.bluereader.common.FeatureFlagHandler;
...
import org.omegaaol.bluereader.fragments.ChangelogDialog;
...
public class MainActivity extends RefreshableActivity
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		final AndroidCommon.PackageInfo pInfo = BlueReader.getInstance(this).getPackageInfo();
		...
		if(!sharedPreferences.contains(FeatureFlagHandler.PREF_FIRST_RUN_MESSAGE_SHOWN)) {
			...
			if (Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT){ // warnings for navbar suppport
			    DialogUtils.showDialog(this, R.string.firstrun_kitkat_navbar_warning_title, R.string.firstrun_kitkat_navbar_warning_message);
			}

			else if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.JELLY_BEAN_MR2){
				DialogUtils.showDialog(this, R.string.firstrun_jellybean_navbar_warning_title, R.string.firstrun_jellybean_navbar_warning_message);
			}
			...
			if (sharedPreferences.getInt(FeatureFlagHandler.PREF_LAST_VERSION, 0) < appVersion){
