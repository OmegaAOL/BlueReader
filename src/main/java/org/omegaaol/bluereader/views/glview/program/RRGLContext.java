...
package org.omegaaol.bluereader.views.glview.program;
...
public final class RRGLContext {
	...
	private final RRGLProgramColor mProgramcolor;
	...
	public RRGLContext(final Context context) {
		...
		mProgramcolor = new RRGLProgramColor();
		mContext = context;
	}
	...
	public void activateProgramColor() {
		if(mProgramCurrent != mProgramcolor) {
			activateProgram(mProgramcolor);
		}
	}
	...
	public void activateColor(
			...
			final float b,
			final float a) {
		mProgramcolor.activateColor(r, g, b, a);
	}
