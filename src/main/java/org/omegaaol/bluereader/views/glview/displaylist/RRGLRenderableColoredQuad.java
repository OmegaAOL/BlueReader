...
package org.omegaaol.bluereader.views.glview.displaylist;
...
public class RRGLRenderableColoredQuad extends RRGLRenderable {
	...
	public RRGLRenderableColoredQuad(final RRGLContext glContext) {
	...
	protected void renderInternal(final RRGLMatrixStack matrixStack, final long time) {
		...
		mGLContext.activateProgramColor();

		matrixStack.flush();

		mGLContext.activateVertexBuffer(mVertexBuffer);
		mGLContext.activateColor(mRed, mGreen, mBlue, mAlpha * mOverallAlpha);
