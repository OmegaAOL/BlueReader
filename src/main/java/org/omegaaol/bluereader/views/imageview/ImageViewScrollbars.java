...
package org.omegaaol.bluereader.views.imageview;

import org.omegaaol.bluereader.common.MutableFloatPoint2D;
import org.omegaaol.bluereader.views.glview.displaylist.RRGLRenderable;
import org.omegaaol.bluereader.views.glview.displaylist.RRGLRenderableBlend;
import org.omegaaol.bluereader.views.glview.displaylist.RRGLRenderableColoredQuad;
import org.omegaaol.bluereader.views.glview.displaylist.RRGLRenderableGroup;
import org.omegaaol.bluereader.views.glview.displaylist.RRGLRenderableScale;
import org.omegaaol.bluereader.views.glview.displaylist.RRGLRenderableTranslation;
import org.omegaaol.bluereader.views.glview.program.RRGLContext;
import org.omegaaol.bluereader.views.glview.program.RRGLMatrixStack;
...
public class ImageViewScrollbars extends RRGLRenderable {
	...
	public ImageViewScrollbars(
		...
		// Vertical scroll bar
		{
			...
			final RRGLRenderableColoredQuad vScrollMarker =
					new RRGLRenderableColoredQuad(glContext);
			final RRGLRenderableColoredQuad vScrollBar =
					new RRGLRenderableColoredQuad(glContext);
			final RRGLRenderableColoredQuad vScrollBorder =
					new RRGLRenderableColoredQuad(glContext);

			vScrollMarker.setcolor(1, 1, 1, 0.8f);
			vScrollBar.setcolor(0, 0, 0, 0.5f);
			vScrollBorder.setcolor(1, 1, 1, 0.5f);
		...
		// Horizontal scroll bar
		{
			...
			final RRGLRenderableColoredQuad hScrollMarker =
					new RRGLRenderableColoredQuad(glContext);
			final RRGLRenderableColoredQuad hScrollBar =
					new RRGLRenderableColoredQuad(glContext);
			final RRGLRenderableColoredQuad hScrollBorder =
					new RRGLRenderableColoredQuad(glContext);

			hScrollMarker.setcolor(1, 1, 1, 0.8f);
			hScrollBar.setcolor(0, 0, 0, 0.5f);
			hScrollBorder.setcolor(1, 1, 1, 0.5f);
